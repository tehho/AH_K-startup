...
y := y + h + 5
settings := "x" . x . " y" . y . " w" . w . " h" . h
Gui, Add, Edit, vNummer %settings%, Nummer det gäller

y := y + h + 5
settings := "x" . x . " y" . y . " w" . w
Gui, Add, DropDownList, vOperatör %settings%, Qall||Teloteket|Fonia|SST Net|Fastcom|Tellit
...
y := y + h + 5
settings := "x" . x . " y" . y . " w" . w . " h" . h
Gui, Add, DateTime, VÖppnas %settings%,
