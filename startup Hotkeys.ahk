...
Gui, Add, Edit, vm_path w100 x10 y10, Överlåtelse
...
:*:märta.a::marta.astrom@telenor.se
:*:marta.å::marta.astrom@telenor.se
:*:märta.å::marta.astrom@telenor.se
...
::frte::firmatecknare
:*:förlänging::förlängning
:*:förlägning::förlängning
:*:förlägnig::förlängning
:*:uppsägnign::uppsägning
:*:uppsägnig::uppsägning
:*:uppsäging::uppsägning
:*:uppsägign::uppsägning
...
::.övsamma::
	...
	m_clipboard := clipboard
	FileRead, clipboard, G:\SME BO\Autostart\mallar\Överlåtelse - Samma.txt
	Sleep 100
	Send ^v
	Sleep 100
	clipboard := m_clipboard
...
::.övprv::
	...
	FileRead, clipboard, G:\SME BO\Autostart\mallar\Överlåtelse - Företag till privat.txt
	Sleep 100
	Send ^v
	Sleep 100
	clipboard := m_clipboard
...
::.övftg::
	...
	m_clipboard := clipboard
	FileRead, clipboard, G:\SME BO\Autostart\mallar\Överlåtelse - Privat till Företag.txt
	Sleep 100
	Send ^v
	Sleep 100
	clipboard := m_clipboard
...
::.ejbehörig::
	m_clipboard := clipboard
	FileRead, clipboard, G:\SME BO\Autostart\mallar\Storkundshänvisning.txt
	Sleep 100
	Send ^v
	Sleep 100
	clipboard := m_clipboard
...
::.nyportal::
	...
	m_clipboard := clipboard
	FileRead, clipboard, G:\SME BO\Autostart\mallar\Beställning Ftg.portal - nytecknande.txt
	Sleep 100
	Send ^v
	Sleep 100
	clipboard := m_clipboard
...
::.begäran::
	...
	m_clipboard := clipboard 
	FileRead, clipboard, G:\SME BO\Autostart\mallar\Begäran.txt
	Sleep 100
	Send ^v
	Sleep 100
	clipboard := m_clipboard
...
::.portal::
	...
	m_clipboard := clipboard
	FileRead, clipboard, G:\SME BO\Autostart\mallar\Företagsportalen.txt
	Sleep 100
	Send ^v
	Sleep 100
	clipboard := m_clipboard
...
_test = %m_Välkommen%`r`n`r`n`r`n

if (m_thread_id != 0)
{
	_test = %_test%`r`n%m_npslänk%`r`nhttps://response.easyresearch.se/s.asp?WID=999476&Pwd=15768943&foreignid=%m_thread_id%`r`n
}
...
!^w::
Run, G:\SME BO\Autostart\startup Företagsavtal.ahk 
Return
...
Gui, Add, Text, x10 y80 w80,Företagsnamn:
...
MsgBox, Hjälp lista:`r`n`r`nCtrl+Alt+R: Ladda om skriptet, hämtar nya inställningar ifrån H:\Settings.txt`r`n`r`nCtrl+Alt+U: Uppdaterar ditt skript till det senaste ifrån G:\SME BO\Autostart`r`n`r`nWindows+D: Skriver Automeddelande i siebel.`r`n`r`nAlt+S: Skapar en mall med kontaktinfo för kp.`r`n`r`nCtrl+V: Fungerar i BASS.`r`n`r`nCtrl+ALt+W: Företagsportalen mallen.`r`n`r`nCtrl+Alt+Q
